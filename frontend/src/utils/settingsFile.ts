...
export function applySettingsFile(raw: unknown): ApplySettingsResult {
  ...
  if (bookmarkDrawerSortMode === 'custom' || bookmarkDrawerSortMode === 'folders-first' || bookmarkDrawerSortMode === 'links-first' || bookmarkDrawerSortMode === 'alphabetical') {
